...
for (K in 1:5) {
 ...
 # produce a plot of how well the model fits the data for K from 1 to 5
  ...
  e = exp(n0.hat)
  for (i in seq_along(beta.hat)) {
    e = e * exp(beta.hat[i] * t^i)
  }
...
# H_0
K0 = 3 
par0 = integer(K0+1) # dimension of theta in H_0
theta0 = optim(par0, neg_loglike, method="BFGS", y=cov$CMODateCount) # MLE for theta when K=3

# H_1
K1 = 4
par1 = integer(K1+1) # dimension of theta in H_1
...
# finds approximate 95% confidence intervals for logN(t)
